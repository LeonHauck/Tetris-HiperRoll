...
//
// Ao hospedar no HostGator (ou outro servidor com PHP + MySQL), suba a
// pasta "api/" junto com o site e aponte o caminho abaixo para ela.
// Exemplos:
//   apiBaseUrl: '/api'                                (mesmo domínio)
